...
independently checked kernel, whereas Glucose4's DRAT certificates
require a separate checker and are not human-readable.  On PHP$_4^{5}$,
\NP{} correctly reports UNKNOWN at the 50{,}000-conflict limit,
consistent with the exponential resolution lower bound.  On 3-CNF
at $\alpha=4.0$, \NP{} solves SAT instances in 12\,ms median but
times out on harder UNSAT instances; times are reported as
``SAT median / UNSAT mean''.
