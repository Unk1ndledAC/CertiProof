...
(1)~a \emph{certified natural deduction kernel}
independently verified in Rocq~8.19 to satisfy the
...
with the soundness theorem \emph{mechanically verified} in Rocq;
the calculus p-simulates Frege and is therefore complete.
...
$3$\,ms each (proof sizes 2--7, depths 1--4).
...
The \NP{} kernel is formalised in Rocq/Coq~8.19+ (487~lines).
