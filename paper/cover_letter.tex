...
``\textbf{CertiProof: A Hybrid Propositional Proof System with
...
implementation efficiency, enabling a fair comparison of \CP{}'s
algorithmic core with industrial-strength C/C++ solvers.  The
empirical result is that the \CP{} kernel performs operation counts
...
For \textbf{CAV~2027}, \CP{} contributes to formal verification by
