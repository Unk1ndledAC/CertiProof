...
\title{CertiProof: A Hybrid Propositional Proof System with\\
  Adaptive Tactic Synthesis and Certified Proof Checking}
...
% ============================================================
\begin{abstract}
We present \CP{}, a hybrid propositional proof system that
...
and p-simulates Frege (hence complete). Experimentally, \CP{} proves
...
itself rather than just its output.  \CP{} extends this philosophy
...
\CP{}'s performance in a hypothetical optimised C/C++ port.
...
\begin{figure}[t]
  ...
  \caption{Operation-primitive cost comparison: Python vs.\ estimated
    ...
    conflict-analysis operations dominate \CP{}'s runtime.}
  \label{fig:op-costs}
\end{figure}
...
\begin{enumerate}
  ...
  \item \textbf{Operation-count analysis.}  At $n=4$, \CP{} performs
    ...
    interpolation overhead unique to \CP{}.
  ...
  \item \textbf{Honest failure is a feature.}
    ...
    counts confirm that \CP{}'s algorithmic core performs comparably
...
\CP{}'s 5.6\,s reflects ${\sim}37{,}000$ cycles at the conflict
...
\CP{}'s operation counts are \emph{not} a pure efficiency loss:
...
resolution~\cite{CookReckhow1979,Krajicek1995}.  While \CP{}'s
...
\begin{enumerate}
  ...
  \item \textbf{Empirical evidence for the virtuous cycle.}
    ...
    a $7.5\times$ speedup of \CP{}+\ATSS{} over DPLL-Baseline on
...
The virtuous cycle is the key architectural insight of \CP{}:
...
what distinguishes \CP{} from every existing proof system.
